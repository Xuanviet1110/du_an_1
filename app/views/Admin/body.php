      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="app/modelsadmin/QTBL/list.html" class="nav-link">Quản Trị bình luận </a>
            </li>
            <li class="nav-item">
              <a href="app/modelsadmin/QTDM/list.html" class="nav-link">Quản Trị danh mục </a>
            </li>
            <li class="nav-item">
              <a href="app/modelsadmin/QTKH/list.html" class="nav-link">Quản Trị khách hàng</a>
            </li>
            <li class="nav-item">
              <a href="app/modelsadmin/" class="nav-link">Quản Trị sản phẩm </a>
            </li>
            <li class="nav-item">
              <a href="app/modelsadmin/QTKM/list.html" class="nav-link">Quản Trị Khuyến mại </a>
            </li>
            <li class="nav-item">
